...
df = data.frame(x = c(5.5, 4.8, 4.7, 3.9, 4.5, 6.2, 6, 5.2, 4.7, 4.3, 4.9, 5.4, 5, 6.3, 4.6, 4.3, 5, 5.9, 4.1, 4.7),
           y = c(3.1, 2.3, 3, 1.9, 2.5, 3.7, 3.4, 2.6, 2.8, 1.6, 2, 2.9, 2.3, 3.2, 1.8, 1.4, 2, 3.8, 2.2, 1.5))

df = data.frame(x = c(7, 6, 5, 1, 5, 4, 7, 3, 4, 2, 8, 5, 2, 5, 7, 1, 4, 5),
           y = c(97, 86, 78, 10, 75, 62, 101, 39, 53, 33, 118, 65, 25, 71, 105, 17, 49, 68)) 

df = data.frame(x = c(1, 0, 2, 0, 3, 1, 0, 1, 2, 0),
           y = c(16, 9,  17, 12, 22, 13, 8, 15, 19, 11))

df = data.frame(x = c(32, 48, 72, 64, 48, 16, 40, 48, 48, 24, 80, 56),
...
pf(
  ...
  (ncol(x)-1), (n-ncol(x)), lower.tail = F
)
