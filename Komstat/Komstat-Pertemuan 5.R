...
plot(x = df$Illiteracy,y = df$HS.Grad,xlab = "Illiteracy",
...
plot(x = df[,3],y = df[,6],xlab = "Illiteracy",
...
# Simple pie chart
pie(tab,col = rainbow(length(tab),start = 0.1,end = 0.8),
    clockwise = T)
legend("topright",legend = row.names(tab),cex = 1.3,
...
plot(tahun,dki,xlab = "Tahun",ylab = "Gini Ratio",type = "l",
...
legend("topleft",c("DKI","Jabar"),col = 1:2,pch = list(17,3),
       lty = 1:2,lwd = 2)
