...
#Unpaired Two sample t test
Ban <- data.frame(kelBan = rep(c("radial", "Biasa"), each=12),
                  KPL=c(4.2,4.7,6.6,7,6.7, 4.5, 5.7, 6, 7.4,4.9,6.1, 5.2, 4.1, 4.9, 6.2,
...
boxplot(count~spray, data=subset.insectSpray,
