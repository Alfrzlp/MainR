...
img_text <- implot(img, {
  text(150, 690, "08:00", col = "white", cex = 5, lwd = 1)
})
img_text <- implot(img_text, {
  text(200, 740, "Senin, 15 Februari 2021", col = "gray", cex = 2.5)
})
...
image_text <- image_annotate(image, "08:00",
  color = "white", size = 50,
  weight = 700, location = "+150+690"
)
image_text <- image_annotate(image_text, "15 Februari 2021",
  color = "gray", size = 25,
