...
indo = readOGR(dsn = "D:/Datasets/gadm36_IDN_shp", layer = "gadm36_IDN_3",
               stringsAsFactors = F)
...
ggplot(sidoarjo, aes(x=long, y=lat)) + 
  ...
  theme(title = element_text(face="bold"),
        legend.position = "bottom") #pindah bawah
