...
n_sampel(berat_badan,
  d = 0.1 * mean(berat_badan),
  alpha = 0.05, type = "wr"
)

n_sampel(tinggi_badan,
  d = 0.1 * mean(tinggi_badan),
  alpha = 0.05, type = "wr"
)
...
n_sampel(jumlah_anggota_keluarga,
  d = 0.1 * mean(jumlah_anggota_keluarga),
  alpha = 0.05, type = "wr"
)
...
sample_stratified(data,
  strata = kelas, variabel = berat_badan,
