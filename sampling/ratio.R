...
a = data.frame(x = c(4.63, 2.9, 1.45, 3.38, 5.17, 3.35),
               y = c(290.6, 179.5, 92.3, 212.4, 318.7, 221.4))
b = data.frame(x = c(8.66, 6.61, 7.35, 9.87, 6.42, 8.6, 9.7, 6.75),
               y = c(565.1, 436.2, 490.6, 648.1, 450.5, 560.7, 635.5, 446))
c = data.frame(x = c(11.6, 15.29, 17.94, 14.29, 18, 13.2, 11.5, 14.7, 12.01, 17.96, 23.15),
...
ratioEst <- function(data, Nh, Xh, metode = 'separate'){
  ...
  i = which.max(c(grepl(metode, "separate"),
