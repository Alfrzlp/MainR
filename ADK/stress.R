...
col_name <-
  c(
    "waktu", "jabatan", "lama_rapat", "n_rapat", "n_tugas",
...
ggplot(hasil, aes(y = lama_rapat, x = kat_stress)) +
  ...
  labs(
    y = "Rata-Rata Lama Rapat Dalam Seminggu (Jam)",
    x = NULL
  ) +
  theme_minimal() +
  theme(
...
ggplot(hasil, aes(y = n_rapat, x = kat_stress)) +
  ...
  scale_fill_brewer("Kategori Stress", palette = "RdYlGn", direction = -1) +
  labs(
    y = "Banyaknya Rapat PKL Dalam Seminggu",
    x = NULL
  ) +
  scale_y_continuous(
    labels = 0:7,
...
ggplot(hasil, aes(y = n_tugas, x = kat_stress)) +
  ...
  geom_jitter(shape = 16, position = position_jitter(0.15)) +
  labs(
    y = "Banyaknya Tugas Kuliah Dalam Seminggu",
    x = NULL
  ) +
  scale_y_continuous(
    labels = 0:7,
...
hasil %>%
  ...
  scale_fill_brewer("Kategori Stress", palette = "RdYlGn", direction = -1) +
  labs(
    x = "Banyaknya Organisasi yang Masih Diikuti",
    y = NULL
  ) +
...
hasil %>%
  ...
  scale_fill_brewer("Kategori Stress", palette = "RdYlGn", direction = -1) +
  labs(
    x = "Banyaknya Rapat Organisasi Dalam Seminggu",
    y = NULL
  ) +
  scale_x_continuous(
    labels = 0:4,
